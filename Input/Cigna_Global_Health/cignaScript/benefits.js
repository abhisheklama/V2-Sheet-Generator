...
const opcopay = [
  ...
  '$500, 30% Co-insurance, $3,000 Out of pocket'
    ...
    const files = [
      "/home/support/Desktop/saleslabb/V2-Sheet-Generator (Main)/Input/Cigna_Global_Health/cignaScript/inputRates/benefits.xlsx",
    ];
    ...
    files.forEach((path, p) => {
      ...
      codes.forEach((codeName, i) => {
          ...
          xlsx.writeFile(
            wb,
            `/home/support/Desktop/saleslabb/V2-Sheet-Generator (Main)/Input/Cigna_Global_Health/cignaScript/output/benefits/benefits${i}.xlsx`
          );
      })
